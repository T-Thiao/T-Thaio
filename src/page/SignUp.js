        ...
        <div class="container">
          <div class="row">
            <div class="col-12 col-xl-6 px-5 ">
              <div class="h2 pt-5  text-start">Create new account.</div>
              ...
              <div class="pb-5">
                <button onClick={SingUpHandler} className="CREATE">
                  Create Account
                </button>
              </div>
            ...
            <div class="col-6 signupLogin"></div>
          </div>
        </div>
      </div>
      ...
      {showPopupReqiured && (
        <div id="popup4" className="overlay">
          <div className="popup4 h1 text-center">
            ...
            <div className="h4 py-4">
              <b>Please enter reqiured info</b>
            </div>
          </div>
        </div>
      )}
